...
type dhGEXSHA256 struct {
	g, p *big.Int
}

func (gex *dhGEXSHA256) diffieHellman(theirPublic, myPrivate *big.Int) (*big.Int, error) {
...
func (gex *dhGEXSHA256) Client(c packetConn, randSource io.Reader, magics *handshakeMagics) (*kexResult, error) {
...
func (gex *dhGEXSHA256) Server(c packetConn, randSource io.Reader, magics *handshakeMagics, priv Signer) (result *kexResult, err error) {
	hashFunc := crypto.SHA256
